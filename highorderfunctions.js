...
//has array,map,,filter,some,every,unshift,shift,push
...
a=[1,2,3,4,5];
a.push(7); //adds 7 to the end of the array
a.pop(); //removes the last element of the array
a.unshift(9)//inserts at the beginning of the array
a.shift()//removes from the beginning of the array
a.unshift(9,10,11)//all three elements are added at the start of the array
